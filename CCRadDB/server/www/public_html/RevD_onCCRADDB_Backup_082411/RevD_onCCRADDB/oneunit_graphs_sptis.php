...
<?php
		...
		while ($row1 = mysql_fetch_assoc($result11)) {	
			...
			{
				echo "<div id =\"left\">";
				echo "<div style=\"color:white;padding: 15px 15px;text-decoration: none;letter-spacing: 1px;background-color: #555; \">";
...
while($m!=0)
		{   
			...
			/*echo "select data from masterTable where ";*/
				...
				if($column_no!=19){$sqlquerytogetdata.= " AND ";}				
				} 
				...
				$finaldata[$count][$i18][$i19]=$cell[0];
				}
				/*echo $finaldata[$count][$i18][$i19]."</br>";*/
$i19++;
$m--;
}	
$i18++;
}
for($column_no=13;$column_no<17;$column_no++)  
{					
