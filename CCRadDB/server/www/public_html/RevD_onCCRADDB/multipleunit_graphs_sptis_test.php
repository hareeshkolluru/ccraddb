...
$result14 = mysql_query("SELECT distinct SpecOwner FROM ". $table3. " ORDER BY SpecOwner DESC");
$result15 = mysql_query("SELECT distinct Mgate FROM ". $table3. "");
$result16 = mysql_query("SELECT distinct TestCase FROM ". $table3. " ORDER BY TestCase ASC");
...
/*	
var container";
echo $noofcontainer." = $('#container";
echo $noofcontainer."')[0];
$('#resizer').resizable({
...
*/
	echo "			chart".$noofcontainer." = new Highcharts.Chart({
					chart: {
						renderTo: 'container";
						echo $noofcontainer."',
						height: 780,
...
echo
"
<a href=\"javascript:void();\" onclick=\"document.getElementById('underlay').style.display='block'; document.getElementById('lightbox').style.display='block';\">Advanced Options</a>

<div id=\"underlay\">";

echo "<FORM NAME=\"myform\" ACTION=\"\" METHOD=\"GET\">
Chart Title:<INPUT TYPE=\"text\" id=\"charttitle\" VALUE=\"\"><P>
...
function testResults (form) {
   chart".$noofcontainer.".xAxis[0].setExtremes(0, 5);
   chart".$noofcontainer.".setTitle({ text: document.getElementById('charttitle').value});
};
...
echo "<div id=\"resizer\">
    <div id=\"inner-resizer\"><div id=\"container".$noofcontainer."\" style=\"width: 1180px; height: 800px; margin: 1.5em; float:left; border:2px solid #aaa;\">
