...
{ $i17=0;
$container_channel_string[$i17]="'";
$numberofchannels[$i17]=0;
...
echo "<script type=\"text/javascript\">
			...
			$(document).ready(function() {
				chart".$noofcontainer." = new Highcharts.Chart({
					...
					xAxis: {
						...
						categories: [".$container_channel_string[$noofcontainer]."]
					},
        ...
        series: {
				...
				echo "<div id=\"container-".$noofcontainer."\" style=\"width: 1180px; height: 600px; margin: 1.5em; float:left; border:2px solid black;\">
...
<table border='1' id=\"hor-minimalist-b\">
<th>Chart</th></tr>
<tr><td>Title</td>
<td><INPUT TYPE=\"text\" NAME=\"charttitle\" VALUE=\"\"></td></tr>
<tr>
<th>Y Axis:</th> 
</tr>
<tr><td>Title</td><td><INPUT TYPE=\"text\" NAME=\"yaxistitle\" VALUE=\"\"></td></tr>
<tr><td>Min</td><td><INPUT TYPE=\"text\" NAME=\"yaxismin\" VALUE=\"\"></td></tr>
<tr><td>Max</td><td><INPUT TYPE=\"text\" NAME=\"yaxismax\" VALUE=\"\"></td></tr>
<tr><td>MajorGridLineStep</td><td><INPUT TYPE=\"text\" NAME=\"yaxismajorstep\" VALUE=\"\"></td></tr>
<tr><td>MinorGridLineStep</td><td><INPUT TYPE=\"text\" NAME=\"yaxisminorstep\" VALUE=\"\"></td></tr>


<tr>
<th>X Axis:</th> 
</tr>
<tr><td>Title</td><td><INPUT TYPE=\"text\" NAME=\"xaxistitle\" VALUE=\"\"></td></tr>
<tr><td>Min</td><td><INPUT TYPE=\"text\" NAME=\"xaxismin\" VALUE=\"\"></td></tr>
<tr><td>Max</td><td><INPUT TYPE=\"text\" NAME=\"xaxismax\" VALUE=\"\"></td></tr>
<tr><td>MajorGridLineStep</td><td><INPUT TYPE=\"text\" NAME=\"xaxismajorstep\" VALUE=\"\"></td></tr>
<tr><td>MinorGridLineStep</td><td><INPUT TYPE=\"text\" NAME=\"xaxisminorstep\" VALUE=\"\"></td></tr>
...
function testResults (form) {
   chart0.yAxis[0].setExtremes(form.yaxismin.value, form.yaxismax.value);
   chart0.yAxis[0].tickInterval=form.yaxismajorstep.value;
   chart0.yAxis[0].minorTickLength=form.yaxisminorstep.value;
