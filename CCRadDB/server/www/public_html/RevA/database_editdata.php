...
?>	
				...
				<p> Select your Hardware Rev 
				<select name="d" class="styled">
				  <option value="1">P1A</option>
				  <option value="1">P1B</option>
				  <option value="1">P2A</option>
				  <option value="1">P2B</option>
				  <option value="1">P3A</option>
				  <option value="1">P3B</option>
				</select>
				
				 Select your Unit No 
				<select name="d" class="styled">
				  <option value="1">LHBA24001</option>
				  <option value="1">LHBA24001</option>
				  <option value="1">LHBA24001</option>
				  <option value="1">LHBA24001</option>
				  <option value="1">LHBA24001</option>
