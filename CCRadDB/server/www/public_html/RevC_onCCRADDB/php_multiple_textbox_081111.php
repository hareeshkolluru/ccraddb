...
while($_POST["txtSiteName_temp"][18][$m3])
{
				...
				case 16: $_POST["txtSiteName"][$column_no]=$_POST["txtSiteName_temp"][$column_no][$m1];
						break;
				case 17: $_POST["txtSiteName"][$column_no]=$_POST["txtSiteName_temp"][$column_no][$m2];
						break;
				case 18: $_POST["txtSiteName"][$column_no]=$_POST["txtSiteName_temp"][$column_no][$m3];
						
				         switch ($_POST["txtSiteName_temp"][$column_no][$m3])
						 {
						 case 'GSM 850':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'GSM 900':$_POST["txtSiteName"][$column_no+1]=GSM900;break;
						 case 'GSM 1800':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'GSM 1900':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'CDMA 800':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'CDMA 1900':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'WCDMA B5':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'WCDMA B8':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'WCDMA B2':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'WCDMA B4':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'WCDMA B1':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'LTEB 4':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'LTEB 13':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						 case 'LTEB 17':$_POST["txtSiteName"][$column_no+1]=GSM850;break;
						}		
						break;
				}
